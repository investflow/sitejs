export class Broker {
    ...
    public static GERCHIK:Broker = new Broker(33, "Gerchik&Co");
    public static TELETRADE:Broker = new Broker(34, "TeleTrade");
    public static ICEFX:Broker = new Broker(35, "ICE-FX");
